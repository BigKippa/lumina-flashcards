...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ user, onSelect, lastSession, favorites, onQuickStart, onSelectFavorite, onToggleFavorite, onNavigate }) => {
    ...
    return (
        <div className="flex flex-col items-center min-h-[60vh] w-full py-8">
            <div className="flex flex-col gap-6 w-full max-w-6xl mx-auto mt-6">
                ...
                <div data-dev-id="student-hero-tile" className="lumina-glow lumina-glow-hero hover-glow-5 bg-color5 border border-color5/50 rounded-3xl p-8 flex flex-col md:flex-row gap-8 items-center shadow-md text-color1">
                    ...
                    <div className="flex flex-wrap md:flex-nowrap justify-center gap-4 relative z-10 w-full md:flex-1">
                        ...
                        >
                            ...
                            <span className="text-2xl font-bold text-color1">{favorites.length}</span>
                ...
                <div data-dev-id="student-tiles-grid" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    >
                        <div className="absolute -right-6 -top-6 w-24 h-24 bg-color1 rounded-full blur-2xl group-hover:bg-color2 transition-colors opacity-20 group-hover:opacity-35 pointer-events-none"></div>
                    ...
                    >
                        <div className="absolute -right-6 -top-6 w-24 h-24 bg-color1 rounded-full blur-2xl group-hover:bg-color5 transition-colors opacity-20 group-hover:opacity-35 pointer-events-none"></div>
